...
class Dishdetail extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      dishes: DISHES,
      comments: COMMENTS, //taking in all the comments from the server
      favorites: [] //this will keep track of all favourite dishes
    };
  }

  markFavorite(dishId) { //this will add this dishId to favorites array and save it their
