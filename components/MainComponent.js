...
function MainNavigatorDrawer() {
  return (
    ...
    <MainNavigator.Navigator
      ...
      <MainNavigator.Screen name="Login" component={LoginNavigatorScreen} options={{
...
class Main extends Component {
  ...
  componentDidMount() { //when the main component is mounted, we will dispatch all these
    ...
    NetInfo.fetch()
      .then((connectionInfo) => {
        if (connectionInfo.details.cellularGeneration !== undefined) {
          ToastAndroid.show('Initial Network Connectivity Type: '
            + connectionInfo.type + ', effectiveType: ' + connectionInfo.details.cellularGeneration,
            ToastAndroid.LONG)
        }
        else {
          ToastAndroid.show('Initial Network Connectivity Type: '
